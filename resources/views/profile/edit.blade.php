{{-- 
    ...
    Tujuan: Halaman edit profil dengan validasi dan tampilan modal untuk setiap field.
--}}
...
<style>
    ...
    .profile-label-group .label {
        font-size: 0.9rem;
        color: #6c757d;
        margin-bottom: 0.25rem;
    }
    .profile-label-group .value,
    .profile-label-group .password-dots {
        font-size: 1rem;
        font-weight: 500;
        color: #212529;
    }
    ...
    .profile-photo .bi-person-circle {
        font-size: 2.5rem;
        color: #6c757d;
    }
    .profile-avatar {
...
<div class="container py-4">
    <div class="content-header mb-4">
        <h1 class="fw-bold" style="font-size: 28px;">Update Profile</h1>
    </div>
    ...
    <div class="info-box">Perbaharui Informasi Umum akun Anda</div>
            ...
            <div class="profile-label-group">
                ...
                <div class="profile-photo">
                    @if ($user->profile_photo_path)
                        <img src="{{ asset('storage/profiles/' . $user->profile_photo_path) }}" alt="Avatar" class="profile-avatar">
                    @else
